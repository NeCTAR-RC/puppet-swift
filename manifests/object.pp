...
class swift::object(
  ...
  nagios::nrpe::service {
    ...
    'service_swift-object_replication_time':
      check_command => "/usr/local/lib/nagios/plugins/check_replication_time -e object -w ${swift::nagios_warning_threshold} -c ${swift::nagios_critical_threshold}";
